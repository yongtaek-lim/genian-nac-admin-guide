...
#. For **Attribute to Match**, select **MAC and IP** when RADIUS accouting packet contains *Calling-Station-Id* and *Framed-IP-Address*. if accounting packet doesn't have *Framed-IP-Address* attribute or generated by *Generating Accounting* option on Authentication Server setting, select **MAC**
#. Click **Update**